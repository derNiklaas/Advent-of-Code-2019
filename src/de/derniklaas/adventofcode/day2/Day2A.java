...
public class Day2A {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < parts.length / 4 + 1; i++) {
            String opcode = parts[i * 4];
            switch (opcode) {
                case "1": {
                    int numb1 = Integer.parseInt(parts[i * 4 + 1]);
                    int numb2 = Integer.parseInt(parts[i * 4 + 2]);
                    int output = Integer.parseInt(parts[i * 4 + 3]);
                ...
                case "99": {
                    ...
                    System.out.println("Full code: " + out);
                    System.out.println("Output for Question: " + parts[0]);
                    return;
                }
            }
        }
